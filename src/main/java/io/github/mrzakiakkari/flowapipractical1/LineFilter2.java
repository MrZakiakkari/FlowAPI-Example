 ...
 */
public class LineFilter2 extends SubmissionPublisher<String> implements Flow.Processor<String, String>
{
	private final Predicate<String> predicate;

	private Flow.Subscription subscription;
	LineFilter2(Predicate<String> predicate)
	{
	...
	public void onNext(String item)
	{
		...
		{
			Stream<String> stream = Stream.of(item);
